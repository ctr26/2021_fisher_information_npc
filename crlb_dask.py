...
dask.config.set(temporary_directory='~/dask')
DASK_FLAG = 0
# if(DASK_FLAG):
processes = 20
workers = 5
# client = Client(local_directory="/tmp/dask",n_workers=workers,processes=False)
client = Client(local_directory="/tmp/dask")
